...
THREE.MapControls = function (object, domElement) {
  ...
  this.maxPolarAngle = Math.PI / 4; // radians
  ...
  function handleTouchMoveRotate(event) {
    ...
    if (isRotateUp()) {
      ...
      rotateLeft(
        (rotateDeltaStartFingers.angle() - rotateDeltaEndFingers.angle()) *
        scope.rotateSpeed
      );
    }
...
Object.defineProperties(THREE.MapControls.prototype, {
  ...
  noPan: {
    get: function () {
      console.warn(
        "THREE.MapControls: .noPan has been deprecated. Use .enablePan instead."
      );
